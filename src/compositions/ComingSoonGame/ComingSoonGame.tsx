...
import { StyledComingSoonGame } from './ComingSoonGame.styles';

const CURRENT_TIME = new Date().getTime() / 1000;
const NEXT_MONTH_TIME = (new Date().getTime() + 28 * 24 * 60 * 60 * 1000) / 1000;

type ComingSoonGameProps = ComponentPropsWithoutRef<'div'>;

export const ComingSoonGame: React.FC<ComingSoonGameProps> = (props) => {
